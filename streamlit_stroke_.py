...
def run():
    ...
    if add_selectbox == 'Online':
        id =st.number_input('id' , min_value=1000, max_value=80000, value=1000)
        ...
        output=""
        input_dict={'id':id ,'gender': gender,'age':age,'hypertension':hypertension,'heart_disease':heart_disease,'ever_married':ever_married, 'work_type':work_type,'Residence_type':Residence_type, 'avg_glucose_level':avg_glucose_level,'bmi': bmi,'smoking_status':smoking_status}
